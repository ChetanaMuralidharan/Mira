...
**A production-inspired clinical intelligence platform that combines modern data engineering, analytics engineering, Text-to-SQL, retrieval-augmented generation (RAG), and agentic AI to answer healthcare analytics and policy questions using natural language.**
...
- Built a full-stack clinical intelligence platform combining structured healthcare analytics with retrieval-augmented generation (RAG)
- Designed a modern healthcare data platform using Delta Lake, DuckDB, dbt, and Great Expectations
- Implemented a LangGraph-based multi-agent workflow for SQL generation, document retrieval, validation, and response synthesis
- Developed a hybrid reasoning engine capable of combining SQL analytics with clinical guideline retrieval
- Achieved **100% benchmark accuracy** across SQL, RAG, and hybrid reasoning workflows (47/47 questions)
- Built an end-to-end application with FastAPI, Streamlit, PostgreSQL/pgvector, Docker, and MLflow
...
The Streamlit dashboard provides a complete clinical intelligence workspace where users can:

- Ask natural-language clinical and analytical questions
- Automatically generate validated SQL
- Inspect retrieved clinical evidence
- Explore interactive Plotly visualizations
- View execution traces and benchmark metadata
- Browse previous queries

<h3 align="center">MIRA Clinical Intelligence Dashboard</h3>

<p align="center">
<img src="images/mira.png" width="1000">
</p>

<p align="center">
Natural-language clinical analytics with transparent SQL generation, evidence-backed responses, interactive visualizations, and execution traceability.
</p>
```
